...
public class MFRExMain {
    ...
    public static final String VERSION = "${version}"; //This syntax will pull the number from gradle.properties, which is where we want to centralize publishing information
